$(document).ready(function() {
    ...
    form.addEventListener('submit', function(ev) {
        ...
        */
        ...
        /*
         Ajax zahtev ka nekom serveru uz pomoc post metoda
         podaci se salju uz pomoc atributa data i vrednost atributa je jedan objekat.
         kada se podaci vrate obradjuju se u success funkciji ili error funkciji.
         Ovo nece raditi ukoliko nije napisana naredba ev.preventDefault();
         Ovo radi ukoliko postoji neki server koji slusa u pozadini.
         */
        $.ajax('1.php', {
            method: "POST",
            data: {
            ...
            success: function(data, textStatus, jqxhr) {
                greska.innerHTML = data;
                // console.log('server kaze ' + data);
            },
            error: function(jqxhr, textStatus, errorThrown) {
                window.alert("Nastala je greska");
            }
        });
        return true;
    });
